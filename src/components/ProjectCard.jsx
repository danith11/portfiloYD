...
import EdwinImg from "../assets/photography.jpg"
import ForeverImg from "../assets/photography.jpg"
import QuickShowImg from "../assets/photography.jpg"
import BloomWiseImg from "../assets/photography.jpg"
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
      {visibleProjects.map((project, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 bg-slate-800 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-center items-center text-center p-6">
